...
export const ButtonCombinations = (props: ButtonCombinationsProps) => { 
  ...
  const generateCombinationsOfTheSprints = () => {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <button onClick={() => generateCombinationsOfTheSprints()} {...props} disabled={props.inputNamesInArray.length > 1 ? false : true}>{props.title}</button>
